...
func (sd *ScaleDown) deleteNode(node *apiv1.Node, pods []*apiv1.Pod, daemonSetPods []*apiv1.Pod,
	...
	daemonSetPods = selectDSPodsForEviction(daemonSetPods, sd.context.DaemonSetEvictionForOccupiedNodes)
...
func selectDSPodsForEviction(pods []*apiv1.Pod, shouldEvict bool) []*apiv1.Pod {
	if shouldEvict {
